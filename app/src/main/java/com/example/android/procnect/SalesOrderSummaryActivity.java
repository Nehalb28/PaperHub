...
public class SalesOrderSummaryActivity extends AppCompatActivity {
    ...
    private void webCall() {
        final String seller_email = SaveSharedPreference.getUserName(SalesOrderSummaryActivity.this);
        final String Order_Query_URL = "https://paperhubs.com/SalesOrderQuery.php?seller_email="+seller_email;
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Order_Query_URL, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof NetworkError || error instanceof TimeoutError) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SalesOrderSummaryActivity.this, R.style.Theme_AppCompat_Light_Dialog);
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                if (orderID.equals("0")) {
                    ...
                    orderQueryList1.setbuttonstatus("true");
                }
